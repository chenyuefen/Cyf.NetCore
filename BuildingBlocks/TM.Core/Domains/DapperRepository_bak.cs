...
namespace TM.Core.Domains
{
    ...
    public abstract class DapperRepository_bak<TEntity, TKey>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public DapperRepository_bak(ConnectionBase db)
        {
            Db = db;
        }
    ...
    /// </summary>
    /// <typeparam name="TEntity">The type of entity.</typeparam>
    public abstract class DapperRepository_bak<TEntity> : DapperRepository_bak<TEntity, long>
