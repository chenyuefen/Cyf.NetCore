...
namespace TM.Infrastructure.Timing
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static DateTime EndOfMonth(this DateTime date,int diff = 0)
        {
            return new DateTime(date.Year, date.Month + diff, DateTime.DaysInMonth(date.Year, date.Month + diff), 23, 59, 59, 999);
        }
        ...
        public static DateTime BeginOfMonth(this DateTime date,int diff = 0)
        {
            return new DateTime(date.Year, date.Month + diff, 1, 0, 0, 0, 0);
        }
