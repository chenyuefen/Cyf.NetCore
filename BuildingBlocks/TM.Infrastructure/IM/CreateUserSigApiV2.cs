...
// 版权所有。
//
// 文件名：CreateUserSigApiV2
// 文件功能描述： 生成 UserSig 新版本(HMAC-SHA256)
//
// 创建者：庄欣锴
// 创建时间：2020-03-6 09:30
// 
//----------------------------------------------------------------*/
...
{
    public class CreateUserSigApiV2
    {
        private readonly int sdkappid;
        private readonly string key;

        public CreateUserSigApiV2(int sdkappid, string key)
        {
        ...
        private static Stream CompressStream(Stream sourceStream)
        {
            ...
            ZOutputStream streamZOut = new ZOutputStream(streamOut, ComponentAce.Compression.Libs.zlib.zlibConst.Z_DEFAULT_COMPRESSION);
        ...
        /// 
        /// </summary>
        /// <param name="identifier">UserID</param>
        /// <param name="expire">默认过期时间180天 单位秒</param>
        /// <returns></returns>
