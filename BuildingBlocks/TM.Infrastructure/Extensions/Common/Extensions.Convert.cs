...
namespace TM.Infrastructure.Extensions.Common
{
    /// <summary>
    /// 系统扩展 - 类型转换
    /// </summary>
    public static partial class Extensions
    {
        ...
        {
            return input == null ? string.Empty : input.ToString().Trim().ToReplaceForNR();
        }
        ...
        #region ToReplaceForNR（将字符串去除换行符）

        /// <summary>
        /// 去除换行符
        /// </summary>
        /// <param name="textStr"></param>
        public static string ToReplaceForNR(this string textStr)
        {
            return Regex.Replace(textStr, @"[\r\n]", "");
        }
        #endregion
    }
}
