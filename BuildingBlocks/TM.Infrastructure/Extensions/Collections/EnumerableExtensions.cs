...
namespace TM.Infrastructure.Extensions.Collections
{
	...
	public static class EnumerableExtensions
	{
		...
		public static IOrderedEnumerable<T> OrderBy<T, TKey>(this IEnumerable<T> enumerable, Func<T, TKey> keySelector, TKey[] keyArray)
		{
			...
			return enumerable.OrderBy(e =>
				   {
				   	   var index = Array.IndexOf(keyArray, keySelector(e));
