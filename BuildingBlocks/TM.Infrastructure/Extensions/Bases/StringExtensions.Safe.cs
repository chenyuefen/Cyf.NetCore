...
namespace TM.Infrastructure.Extensions
{
    ...
    public static partial class StringExtensions
    {
        ...
        /// <summary>
        /// 在数据万象的处理操作中，有很多参数需要进行 URL 安全的 BASE64
        /// 编码，例如文字水印的文字内容、颜色、字体设置和图片水印的水印图链接。URL 安全的 BASE64 编码具体规则为：
        ...
        /// <returns></returns>
        public static string CIUrlEncodeBase64(this string value, Encoding encoding = null)
        {
            encoding = (encoding ?? Encoding.UTF8);
            var bytes = encoding.GetBytes(value);
            return Convert.ToBase64String(bytes)
