...
namespace TM.Infrastructure.Helpers
{
    ...
    public static partial class Web
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static TM.Infrastructure.Webs.Clients.WebClient Client()
        {
            return new TM.Infrastructure.Webs.Clients.WebClient();
        }
        ...
        /// <returns></returns>
        public static TM.Infrastructure.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class
        {
            return new TM.Infrastructure.Webs.Clients.WebClient<TResult>();
        }
