...
namespace Zhaoxi.AspnetCore.Cache.Redis.Interface
{
    ...
    interface IRedisZSetService  
    {
        ...
        /// 为key添加values集合，values集合中每个value的分数设置为score
        /// </summary>
        bool AddRangeToSortedSet(string key, List<string> values, long score);
        #endregion
        ...
        /// 获取key的所有集合，倒叙输出
        /// </summary>
        List<string> GetAllDesc(string key);
        /// <summary>
        /// 获取集合，带分数
        /// </summary>
        ...
        /// 获取key为value的下标值
        /// </summary>
        long GetItemIndexInSortedSet(string key, string value);
        /// <summary>
        /// 倒叙排列获取key为value的下标值
        /// </summary>
        long GetItemIndexInSortedSetDesc(string key, string value);
        /// <summary>
        /// 获取key为value的分数
        /// </summary>
        ...
        /// </summary>
        long GetSortedSetCount(string key, double fromScore, double toScore);
        /// <summary>
        ...
        /// </summary>
        IDictionary<string, double> GetRangeWithScoresFromSortedSetByHighestScore(string key, double fromscore, double toscore);
        /// <summary>
        ...
        /// </summary>
        IDictionary<string, double> GetRangeWithScoresFromSortedSet(string key, int fromRank, int toRank);
        /// <summary>
